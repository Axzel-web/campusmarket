...
Client (Browser) ↓ Frontend (HTML / CSS / JS + Tailwind) ↓ Firebase (Authentication Layer) ↓ Supabase (Database + Storage Layer) ↓ Vercel (Hosting)
...
VITE_FIREBASE_API_KEY=your_key VITE_FIREBASE_AUTH_DOMAIN=your_domain VITE_FIREBASE_PROJECT_ID=your_project_id

VITE_SUPABASE_URL=your_url VITE_SUPABASE_ANON_KEY=your_key

🧑‍💻 Installation

git clone https://github.com/Axzel-web/campusmarket.git cd campusmarket npm install npm run dev
